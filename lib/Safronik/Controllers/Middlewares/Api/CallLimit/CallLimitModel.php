...
class CallLimitModel{
    ...
    private CallLimitGatewayInterface $gateway;
    
    public function __construct( CallLimitGatewayInterface $gateway, int $interval_duration, int $call_limit, array $parameters, string $actions = 'throw' )
    {
